...
export default function Home({ data }) {
  ...
  console.log(featureIslandFirst, data);
  return (
    <div id="root">
          ...
          <div className="desktop-nav" style={{ top: "0px" }}>
            ...
            <div className="desktop-nav__body">
              ...
              <ul className="menu navigation__main-menu">
                ...
                <li className="menu__item">
                  <a href="/the-techcrunch-list/?tpcc=tclistleftnav">
                    The TC List
                  </a>
                </li>
                <li className="menu__item">
            ...
            <div className="content">
              <div className="feature-island">
                  ...
                  <h2 className="fi-main-block__title">
                    <Link href={`/${featureIslandFirst?.slug}`}>
                      <a className="post-block__title__link">
                        {featureIslandFirst?.title?.rendered}
                      </a>
                    </Link>
                  </h2>
                ...
                <div className="mini-view">
                  {data.map((post) => {
                    return (
                      <article key={post.id} className="mini-view__item mini-item--unread">
            ...
            <ul className="menu site-footer__menu">
              <li className="menu__item menu__item--has-submenu menu__item--no-click">
                ...
                <ul className="menu menu__submenu">
                  ...
                  <li className="menu__item">
                    <a href="/pages/advertisement-events-calendar/">
                      Advertise
                    </a>
                  </li>
                </ul>
...
export async function getStaticProps() {
  const response = await fetch(
    "https://techcrunch.com/wp-json/wp/v2/posts?categories=426637499&per_page=6"
  );
